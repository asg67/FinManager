export default {
  ...
  settings: {
    ...
    initialBalances: "Account Balances",
    balanceChecking: "Checking Accounts",
    balanceCards: "Cards & Deposits",
    balanceDate: "Date",
  ...
  pdf: {
    ...
    deleteAllConfirm: "Delete all transactions ({{count}})? This action cannot be undone.",
    direction: "Direction",
    actions: "",
  },
  bankAccounts: {
    title: "Bank Accounts",
    addConnection: "Connect Bank",
    editConnection: "Edit Token",
    deleteConnection: "Delete Connection",
    deleteConfirm: "Delete connection? Imported transactions will be kept.",
    token: "API Token",
    tokenPlaceholder: "Paste token from bank dashboard",
    label: "Label",
    labelPlaceholder: "E.g.: T-Bank John Doe",
    testConnection: "Test",
  ...
  profile: {
    title: "Profile",
    bankIds: "Bank Identifiers",
    bankIdsHint: "Enter your details for automatic matching when uploading statements",
    sberAccount: "Sber Account Number",
    sberPlaceholder: "40817810...",
    tbankCard: "T-Bank Card Code",
    tbankCardPlaceholder: "Code from statement",
    tbankDeposit: "T-Bank Deposit Contract",
    tbankDepositPlaceholder: "Contract number",
    saved: "Saved!",
  ...
  directory: {
    ...
    categorizationDesc: "Rules for automatic categorization of bank transactions",
    addRule: "Add Rule",
    editRule: "Edit Rule",
    noRules: "No categorization rules",
    rulePattern: "Pattern",
    rulePatternPlaceholder: "Text to search in transactions",
    ruleMatchField: "Search in",
    ruleMatchCounterparty: "Counterparty",
    ruleMatchPurpose: "Purpose",
    ruleMatchAny: "Anywhere",
    ruleDirection: "Direction",
    ruleDirectionAll: "Any",
    ruleDirectionIncome: "Income",
    ruleDirectionExpense: "Expense",
    ruleCategory: "Category",
    ruleArticle: "Article",
    ruleDirectionName: "Direction",
    rulePriority: "Priority",
    deleteRuleConfirm: "Delete categorization rule?",
    accountsBlock: "Accounts & Cards",
    accountsBlockDesc: "Manage company accounts, cards and cash registers",
    addAccount: "Add Account",
    editAccount: "Edit",
    deleteAccountConfirm: "Delete this account? All related transactions will be lost.",
    noAccountsYet: "No accounts. Add your first one.",
    accountName: "Name",
    accountNamePlaceholder: "E.g. Main checking account",
    accountEntity: "Entity",
    accountTypePlaceholder: "Account type",
    accountBankPlaceholder: "Bank",
