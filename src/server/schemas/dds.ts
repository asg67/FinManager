...
export const createOperationSchema = z
  .object({
    ...
    incomeDirection: z.string().max(255).optional(),
    currencyAmount: z.number().positive().optional(),
...
export const updateOperationSchema = z.object({
  ...
  incomeDirection: z.string().max(255).optional().nullable(),
  currencyAmount: z.number().positive().optional().nullable(),
